...
inline PDDLParser::token_number_type
...
inline PDDLParser::syntax_error::syntax_error(const location_type& l, const std::string& m)
    : std::runtime_error(m)
    , location(l)
{
}
...
// basic_symbol.
template <typename Base>
inline PDDLParser::basic_symbol<Base>::basic_symbol()
    : value()
{
}

template <typename Base>
inline PDDLParser::basic_symbol<Base>::basic_symbol(const basic_symbol& other)
    : Base(other)
    , value()
...
template <typename Base>
inline PDDLParser::basic_symbol<Base>::basic_symbol(typename Base::kind_type t, const semantic_type& v, const location_type& l)
    : Base(t)
    , value()
    , location(l)
{
...
template <typename Base>
inline PDDLParser::basic_symbol<Base>::basic_symbol::~basic_symbol()
{
    clear();
}
...
// by_type.
inline PDDLParser::by_type::by_type()
    : type(empty_symbol)
{
}

inline PDDLParser::by_type::by_type(const by_type& other)
    : type(other.type)
{
}

inline PDDLParser::by_type::by_type(token_type t)
    : type(yytranslate_(t))
{
}
